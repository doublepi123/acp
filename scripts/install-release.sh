...
PROJECT_NAME=${PROJECT_NAME:-acp}
COMMAND_NAME=${COMMAND_NAME:-acp}
REPO=${REPO:-doublepi123/acp}
...
download_file() {
  ...
  echo 'curl or wget is required to download acp.' >&2
  exit 1
}
